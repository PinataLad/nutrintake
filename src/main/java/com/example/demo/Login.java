...
public class Login {
    ...
    //Hashes password with a salt and pepper
    ...
    //Check to see if an email is already in the database
    public static boolean userExists(String username){
        String sql = "SELECT id FROM users WHERE username = ?";

        try(Connection connection  = DatabaseManager.connect(); PreparedStatement stmt = connection.prepareStatement(sql)){
    ...
    //Verifies the user's login attempt is successful by checking user information in database with
    //user input
